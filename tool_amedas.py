...
#    lib_filepath = os.path.dirname(os.path.abspath(__file__)) + '/' + lib
    lib_df = pd.read_csv(lib, encoding='utf-8')
  ...
  # bulk処理の場合
  def get_data_per_10min_bulk(self,output_csv=bool):
    # 総行数を取得します
  ...
  # 個別処理の場合
  def get_data_per_10min_1by1(self,output_csv=bool,station_id_list=None):
    # セクションを指定してすべてのキーを取得
    icnt=0
